...
| _required_copilot_review_          | [CopilotReviewSettings](#copilot-review-settings) or null | If specified, pull requests will be automatically reviewed by copilot                                                                                                                      |                                                                                                                                 |
...
| Key                          | Value   | Description                                                                                              | Notes |
|------------------------------|---------|----------------------------------------------------------------------------------------------------------|-------|
| _review_draft_pull_requests_ | boolean | When this setting is enabled, Copilot will review pull requests that are in draft state                  |       |
| _review_on_push_             | boolean | When this setting is enabled, Copilot will re-review any time new commits are pushed to the pull request |       |

#### Jsonnet Function

``` jsonnet
orgs.newCopilotReview() {
  <key>: <value>
}
```
...
=== "jsonnet"
    ```jsonnet
    orgs.newRepoRuleset('reporuleset') {
