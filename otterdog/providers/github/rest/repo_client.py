...
class RepoClient(RestClient):
    ...
    async def update_team_permission(self, org_id: str, repo_name: str, team_name: str, team_permission: dict[str, Any]) -> None:
        ...
        status, _ = await self.requester.request_json("PATCH", f"/orgs/{org_id}/teams/{team_name}/repos/{org_id}/{repo_name}", data=json.dumps(team_permission))
    ...
    async def add_team_permission(self, org_id: str, repo_name: str, team_name: str, team_permission: dict[str, Any]) -> None:
    ...
    async def delete_team_permission(self, org_id: str, repo_name: str, team_name: str) -> None:
        ...
        status, _ = await self.requester.request_raw("DELETE", f"/orgs/{org_id}/teams/{team_name}/repos/{org_id}/{repo_name}")
